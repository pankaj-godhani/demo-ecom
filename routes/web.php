...
Route::middleware(['auth:web'])->group(function(){
    ...
    Route::prefix('/user')->group(function () {
        ...
        Route::post('/profile', [FrontendUserProfileController::class, 'userprofileupdate']);
...
Route::get('/view/all/product', [FrontendPageController::class, 'viewallProduct'])->name('view_all_product');
...
Route::get('/categories/{id}', [FrontendPageController::class,'categories'])->name('categories');
...
//category wise products route
Route::get('/category/{id}/{slug}', [FrontendPageController::class,'categoryProducts'])->name('category.products');
...
Route::get('/remove-cart',[CODController::class,'delete'])->name('remove-cart');
//
Route::get('ordercomplete/{order_id}', [CODController::class, 'ordercomplete'])->name('ordercomplete');
Route::get('ordercomplete/{order_id}', [RazorpayPaymentController::class, 'ordercomplete'])->name('ordercompleterazorpay');
...
Route::get('cart-remove',[CODController::class,'delete'])->name('cart-remove');
...
Route::middleware(['auth:admin'])->group(function(){
    ...
    Route::prefix('/admin')->group(function(){
        ...
        Route::get('/change/coupon/status', [CouponController::class, 'changeCouponStatus']);
        ...
        Route::resource('/admindetails',AdminDetailsController::class);
    ...
    Route::post('review_add',[ReviewsController::class,'store']);

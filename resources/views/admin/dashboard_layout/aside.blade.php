        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class=" {{ Request::is('admin/orders/cancel') ? 'active' : '' }}">
                        <a href="{{ route('cancel.orders') }}"><i class="ti-more"></i> Return Orders</a>
                    </li>
                    <li class=" {{ Request::is('admin/orders/return') ? 'active' : '' }}">
                        <a href="{{ route('return.orders') }}"><i class="ti-more"></i>Cancel Orders</a>
                    </li>
                </ul>
            </li>
            ...
            <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class=" {{ ($route == '/extracharge') ? 'active' : '' }}">
                        <a href="{{ route('extracharge.index') }}"><i class="ti-more"></i>Extra Charge</a>
                    </li>
                </ul>
            </li>
            ...
            <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li class=" {{ ($route == '/division') ? 'active' : '' }}">
                        <a href="{{ route('division.index') }}"><i class="ti-more"></i>Country</a>
                    </li>
                    <li class=" {{ ($route == '/division') ? 'active' : '' }}">
                        <a href="{{ route('district.index') }}"><i class="ti-more"></i>State</a>
                    </li>
                    <li class=" {{ ($route == '/state') ? 'active' : '' }}">
                        <a href="{{ route('state.index') }}"><i class="ti-more"></i>City</a>
                    </li>
                </ul>
            </li>
            <li class="treeview {{ ($prefix == '/admindetails') ? 'active' : '' }}">
                <a href="#">
                    <i data-feather="file"></i> <span>Admin Details</span>
                    <span class="pull-right-container">
    <i class="fa fa-angle-right pull-right"></i>
   </span>
                </a>
                <ul class="treeview-menu">
                    <li class=" {{ ($route == '/admindetails') ? 'active' : '' }}">
                        <a href="{{ route('admindetails.index') }}"><i class="ti-more"></i>Admin Details</a>
                    </li>
                </ul>
            </li>

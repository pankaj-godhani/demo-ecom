                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="sorting_1">
                                                        ...
                                                        @elseif ($order->status == 'confirmed')
                                                            <span
                                                                class="badge badge-secondary">{{ $order->status }}</span>
                                                        ...
                                                        @elseif ($order->status == 'return')
                                                            <span
                                                                class="badge badge-danger">Cancel</span>
                                                        @elseif ($order->status == 'cancel')
                                                            <span
                                                                class="badge badge-dark">Return</span>
                                                        @else
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <a href="{{ route('orders.show', $order) }}"
                                                               class="btn btn-success" title="View"><i
                                                                    class="fa fa-eye"></i>
                                                            </a>
                                                            @if ($order->status =='pending')
                                                            ...
                                                            @else
                                                                <a href="{{ route('admin-invoice-download', $order->id) }}"
                                                                   class="btn btn-danger" title="Download"><i
